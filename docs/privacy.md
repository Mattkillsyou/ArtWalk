...
* We do not use analytics, advertising trackers, or any third-party
  SDKs that collect data about you.
...
children. The app is rated 4+ in the App Store.

## Changes

If we change this policy, we'll update the date above and post the new
version in the app's "About" screen.
